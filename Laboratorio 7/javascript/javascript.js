window.onload = function(){ // Onload significa: Acciones tras cargar la página
...
function retro(){ //borra en pantalla solo el ultimo numero escrito
  cifras=x.length; //hayar número de caracteres en pantalla
  br=x.substr(cifras-1,cifras) //informacion del último caracter
  x=x.substr(0,cifras-1) //quitar el ultimo caracter
  if (x=="") {x="0";} //cuando ya no queden caracteres se le coloca el 0
